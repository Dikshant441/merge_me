...
const en = {
  ...
  app: {
    ...
    connections: {
      ...
      titleEm: "main",
      titleB: ".",
      sub: "People you've merged with. Open a chat anytime.",
      message: "Message",
      emptyTitle: "No connections yet.",
      emptySub: "Accept a request — merged people land here.",
      filterAll: "All",
      filterUnread: "Unread",
      filterOnline: "Online",
      filterRecent: "Recent",
    ...
    chat: {
      ...
      titleB: ".",
      sub: "Pick a thread and keep shipping together.",
    },
    requests: {
      titleA: "Your ",
    ...
    saved: {
      titleA: "Your ",
      titleEm: "saved collection",
      titleB: ".",
      sub: "Profiles you bookmarked. Only you can see this list.",
      savedOn: "saved",
      interested: "Interested",
      ignore: "Ignore",
      unsave: "Unsave",
      interestSent: "Request sent",
      ignoredNote: "Moved to the end of your feed",
      alreadyRequested: "A request already exists with this person",
      emptyTitle: "No saved profiles yet.",
      emptySub: "Tap the bookmark on a feed card to keep someone here.",
      saveTooltip: "Save to your collection",
      unsaveTooltip: "Remove from your collection",
...
const hi = {
  ...
  app: {
    ...
    connections: {
      ...
      titleEm: "main",
      titleB: "।",
      sub: "जिनके साथ आपने मर्ज किया। कभी भी चैट खोलें।",
      message: "मैसेज",
      emptyTitle: "अभी कोई कनेक्शन नहीं।",
      emptySub: "रिक्वेस्ट स्वीकार करें — मर्ज हुए लोग यहाँ दिखेंगे।",
      filterAll: "सभी",
      filterUnread: "अनरीड",
      filterOnline: "ऑनलाइन",
      filterRecent: "नए",
    ...
    chat: {
      ...
      titleEm: "बातचीत",
      titleB: "।",
      sub: "कोई थ्रेड चुनें और साथ शिप करते रहें।",
    },
    requests: {
    ...
    saved: {
      titleA: "आपका ",
      titleEm: "सहेजा संग्रह",
      titleB: "।",
      sub: "आपके बुकमार्क किए प्रोफ़ाइल। यह सूची केवल आप देख सकते हैं।",
      savedOn: "सहेजा",
      interested: "रुचि है",
      ignore: "अनदेखा",
      unsave: "हटाएँ",
      interestSent: "अनुरोध भेजा गया",
      ignoredNote: "आपकी फ़ीड के अंत में भेज दिया गया",
      alreadyRequested: "इस व्यक्ति के साथ अनुरोध पहले से मौजूद है",
      emptyTitle: "अभी कोई सहेजा प्रोफ़ाइल नहीं।",
      emptySub: "फ़ीड कार्ड पर बुकमार्क दबाकर किसी को यहाँ रखें।",
      saveTooltip: "अपने संग्रह में सहेजें",
      unsaveTooltip: "अपने संग्रह से हटाएँ",
