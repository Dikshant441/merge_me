import { GitHubIcon, GitLabIcon, GoogleIcon } from "../icons";
...
const OAuthRow = ({ copy }) => {
  const buttons = [
    { key: "github", label: copy.auth.oauthGitHub, Icon: GitHubIcon, hint: copy.auth.oauthHint },
    { key: "gitlab", label: copy.auth.oauthGitLab, Icon: GitLabIcon },
